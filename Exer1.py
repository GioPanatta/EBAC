...
# Tarefa 3: Bivariada com a variável tempo de emprego
...
# Percebe-se que a maior proporção de inadimplentes está na faixa de 1 a 4 anos de tempo de emprego.
# Porém, o pico se dá naqueles com 4,69 anos de emprego.
...
# Uso de 10 árvores de decisão / acurácia 99.77%
...
Atenção: Erro nessa célula Matriz de Confusão. Devido ainda não termos tratado sobre o assunto, não pude resolver, 
    O Erro não afetou a propósta do exercício
